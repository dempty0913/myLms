			...
			<div class="contents">
				...
				<div class="mainContent">
					<ul class="nav nav-tabs selectMode" id="myTab" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">내 스터디</button>
						</li>
					</ul>
					
					<div class="firstLine">
						<p class="firstP">총 <span>10개</span>의 글</p>
						<button type="button" class="insertBtn">등록하기</button>
					</div>
